// bs2b_bridge (variante CamillaDSP)
//
// /usr/local/bin/clang -O3 -march=native -mtune=native bs2b_bridge2.c -o bs2b_bridge2
//
...
static const Perfil PERFIS[] = {
    { "default", "700 Hz / 4,5 dB", 873.89, -2.25, 700.0,  -6.75 },
    { "cmoy",    "700 Hz / 6,0 dB", 868.97, -2.00, 700.0,  -8.00 },
    { "jmeier",  "650 Hz / 9,5 dB", 824.70, -1.40, 650.0, -10.92 },
};
